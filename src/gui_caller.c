...
image_t* rotate_cw(image_t* img, void** args) {
    ...
    image_t* new_img = clone_image(img); // returns the pointer to the new img
...
int start_gui() {
    ...
    image_action_t actions[] = {
        ...
        // submission (and please share in the Forum if you add functionality)
        // {"read", "Read PNG", "document-open", NULL, read_params, 1},
        // { "invert", "Colors", NULL, NULL },
        // { "sepia", "Colors", NULL, NULL },
        // { "blur", "Filters", NULL, NULL },
        // { "sharpen", "Filters", NULL, NULL },
        // { "edge", "Filters", NULL, NULL },
        // { "emboss", "Filters", NULL, NULL },
        // { "red", "Channels", NULL, NULL },
        // { "green", "Channels", NULL, NULL },
        // { "blue", "Channels", NULL, NULL },
        // { "hue", "Channels", NULL, NULL },
        // { "saturation", "Channels", NULL, NULL },
        // { "value", "Channels", NULL, NULL },
        // { "brightness", "Channels", NULL, NULL },
        // { "contrast", "Channels", NULL, NULL },
        // { "gamma", "Channels", NULL, NULL },
        // { "histogram", "Channels", NULL, NULL },
